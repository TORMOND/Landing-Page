...
<div class="wrap">
 ...
 <img :src="profilePic" v-if="profilePic=this.profilePic ">
  ...
  <div class="post-2">
<label  @click="open"><i class="far fa-images"  ></i>Pie</label>
<label  @click="open"><i class="fas fa-user-tag"></i>Meal</label>
<label  @click="open"><i class="fas fa-laugh"></i>Event</label>
</div>
</div>
