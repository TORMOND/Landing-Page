<template>
    ...
    <div class="container">
        <div class="form-section">
            <div class="top-section">
              <h1>Connect Share & Host Events and Meals</h1>
            </div>
            <div class="wrapper">
                <form >
 ...
 <section>
       ...
       <section>
                <input type="number" placeholder="number" class="number-input"> 
        </section>
        <section>
      ...
      <section>
                 <input type="text" placeholder="select your interest" class="name-input">
      </section>
...
.email-input, .password-input, .name-input, .number-input{
  padding: 10px 20px;
  outline: none;
  border: none;
}
